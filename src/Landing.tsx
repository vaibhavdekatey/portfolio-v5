...
const Landing = () => {
  ...
  return (
    <div className="font-lexend relative md:min-h-[94vh] min-h-[90vh] w-full flex flex-col px-[6vw] md:px-[2vw]">
      <div className=" overflow-hidden leading-none my-8">
        ...
        <div className="flex flex-col font-koulen leading-none justify-between text-[16vw] md:text-[11.65vw] z-20">
