...
const iconArr = [
  ...
  },
  {
    ...
    url: "https://www.behance.net/vaibhavdekatey",
  },
  {
    title: "Youtube Icon",
    iconSrc: "/ico/youtube-sq.png",
    url: "https://www.youtube.com/@MendedQuill",
  },
];
...
const About = () => {
  return (
    <div
      id="About"
      className="font-lexend text-neutral-300 w-full min-h-screen flex flex-col pb-8"
    >
      <div
          ...
          <div className="">
            <div className="w-full flex">
              <div>
                ...
                >
                  <p className="text-[3em] lg:md:text-[5em] md:text-[14em] tracking-tighter leading-none text-transparent bg-gradient-to-r from-neutral-300 to-neutral-50 bg-clip-text">
                    DESIGNER
                  </p>
                  <p className="text-[3em] lg:md:text-[5em] md:text-[14em] tracking-tighter leading-none text-transparent bg-gradient-to-r from-neutral-300 to-neutral-50 bg-clip-text">
                    DEVELOPER
              ...
              <div className=" w-full font-normal h-14 justify-end items-start md:flex hidden text-pretty ">
                <p>{"<About Me>"}</p>
              </div>
            </div>
